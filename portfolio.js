...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Raviteja Reddy.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">C.Raviteja Reddy</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Ravi
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="ravi.docx" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="ravi.jpg" alt="lahari"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Chennareddy Raviteja Reddy pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp; Electronics and Communication Engineering.</span> I am passionate about knowing</p>
        ...
        <ul>
          <li>From - Kurnool, India</li>
          <li>Lives in - Kurnool, India</li>
          <li>Age - 20</li>
          <li>Gender - Male</li>
        </ul>
      </section>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Bhashyam H.S.N.R.Peta,Kurnool</p>
              <p>I got 9.2 GPA in my School Education.</p>
          ...
          <div className="con rig">
            ...
            <div className="text-box">
              ...
              <p>I Completed my Intermediate Education at Narayana junior College, Kurnool.</p>
              <p>I got 6.26 GPA in my Intermediate Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 7.39 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 101-2,<br /> Balaji Nagar,<br /> Kurnool,<br /> Kurnool(dist),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="tejareddy0614@gmail.com">tejareddy0614@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 7093874016">7093874016</a></p>
            </div>
          </div>
